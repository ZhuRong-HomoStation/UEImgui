...
struct IMNODEEDITOR_API FringeScaleRef
{
...
struct IMNODEEDITOR_API FringeScaleScope
{
...
struct IMNODEEDITOR_API ObjectId final: Details::SafePointerType<ObjectId>
{
...
struct IMNODEEDITOR_API Object
{
    enum DrawFlags
    {
        None     = 0,
...
struct IMNODEEDITOR_API Pin final: Object
{
    using IdType = PinId;
...
struct IMNODEEDITOR_API Node final: Object
{
    using IdType = NodeId;
...
struct IMNODEEDITOR_API Link final: Object
{
    using IdType = LinkId;
...
struct IMNODEEDITOR_API NodeSettings
{
    NodeId m_ID;
    ImVec2 m_Location;
    ImVec2 m_Size;
...
struct IMNODEEDITOR_API Settings
{
    bool                 m_IsDirty;
    SaveReasonFlags      m_DirtyReason;
...
struct IMNODEEDITOR_API Control
{
    Object* HotObject;
    Object* ActiveObject;
...
struct IMNODEEDITOR_API Animation
{
    enum State
    {
        Playing,
...
struct IMNODEEDITOR_API NavigateAnimation final: Animation
{
...
struct IMNODEEDITOR_API FlowAnimation final: Animation
{
...
struct IMNODEEDITOR_API AnimationController
{
    EditorContext* Editor;
...
struct IMNODEEDITOR_API FlowAnimationController final : AnimationController
{
...
struct IMNODEEDITOR_API EditorAction
{
...
struct IMNODEEDITOR_API NavigateAction final: EditorAction
{
...
struct IMNODEEDITOR_API SizeAction final: EditorAction
{
    bool  m_IsActive;
    bool  m_Clean;
    Node* m_SizedNode;
...
struct IMNODEEDITOR_API DragAction final: EditorAction
{
    bool            m_IsActive;
    bool            m_Clear;
...
struct IMNODEEDITOR_API SelectAction final: EditorAction
{
    bool            m_IsActive;
...
struct IMNODEEDITOR_API ContextMenuAction final: EditorAction
{
...
struct IMNODEEDITOR_API ShortcutAction final: EditorAction
{
...
struct IMNODEEDITOR_API CreateItemAction final : EditorAction
{
    enum Stage
    {
        None,
...
struct IMNODEEDITOR_API DeleteItemsAction final: EditorAction
{
    bool    m_IsActive;
...
struct IMNODEEDITOR_API NodeBuilder
{
    EditorContext* const Editor;
...
struct IMNODEEDITOR_API HintBuilder
{
    EditorContext* const Editor;
    bool  m_IsActive;
    Node* m_CurrentNode;
...
struct IMNODEEDITOR_API Style: ax::NodeEditor::Style
{
...
struct IMNODEEDITOR_API Config: ax::NodeEditor::Config
{
...
struct IMNODEEDITOR_API EditorContext
{
