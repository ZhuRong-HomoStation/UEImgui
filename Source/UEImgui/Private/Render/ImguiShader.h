...
public:
        ...
        : FGlobalShader(Initializer)
	{
		...
		InHasTexture.Bind(Initializer.ParameterMap, TEXT("InHasTexture"), EShaderParameterFlags::SPF_Mandatory);
	}
	...
	template<typename TShaderRHIParamRef>
	void SetHasTexture(FRHICommandListImmediate& RHICmdList, const TShaderRHIParamRef ShaderRHI, int bHasTexture)
	{
		SetShaderValue(RHICmdList, ShaderRHI, InHasTexture, bHasTexture);
	}
private:
